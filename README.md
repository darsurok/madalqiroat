...
<body>
  ...
  const payload = {
    ...
    channel: 'channel3' // Теперь точно пойдёт в нужный канал
  };

  fetch('https://script.google.com/macros/s/AKfycbwGzjIz-Zg45a5NunMDYYgYhvn5V2RxZtGM9JCW_2jGf012uISeiBvug_XKRIbt6pa3lw/exec', {
    method: 'POST',
    mode: 'no-cors',
